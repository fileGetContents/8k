...
<script type="text/javascript" src="{{asset('admin/lib/Highcharts/4.1.7/js/highcharts.js')}}"></script>
<script type="text/javascript" src="{{asset('lib/Highcharts/4.1.7/js/modules/exporting.js')}}"></script>
