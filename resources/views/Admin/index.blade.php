        ...
        <ul>
            <li class="dropDown dropDown_click"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">
                ...
                <ul class="dropDown-menu radius box-shadow">
                    <li><a href="javascript:;" onclick="article_add('添加资讯','article-add')"><i class="Hui-iconfont">
                                &#xe616;</i> 资讯</a></li>
                    <li><a href="javascript:;" onclick="picture_add('添加资讯','picture-add')"><i class="Hui-iconfont">
                                &#xe613;</i> 图片</a></li>
                    <li><a href="javascript:;" onclick="product_add('添加资讯','product-add')"><i class="Hui-iconfont">
                                &#xe620;</i> 产品</a></li>
                    <li><a href="javascript:;" onclick="member_add('添加用户','member-add','','510')"><i
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-page">
            ...
            <dd>
                <ul>
                    <li><a _href="{{URL('page-home')}}" href="javascript:void(0)">首页管理</a></li>
                    <li><a _href="{{URL('page-flinks')}}" href="javascript:void(0)">友情链接</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
