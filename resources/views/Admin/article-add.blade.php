...
<body>
<div class="pd-20">
    <form action="{{URl('article-add/'.$id)}}" method="post" class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>标题：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{{ $article->name }}" placeholder="" id="" name="art_name">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <script id="editor" name="art_content" type="text/plain" style="width:100%;height:400px;">
                    {{ $article->content }}
                </script>
            </div>
        </div>
